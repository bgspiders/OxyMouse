...
class MouseMovement:
    @staticmethod
    @abc.abstractmethod
    def generate_coordinates(from_x: int, from_y: int, to_x: int, to_y: int):
        """
    ...
    @staticmethod
    @abc.abstractmethod
    def generate_random_coordinates(viewport_width: int, viewport_height: int) :
        """
    ...
    @staticmethod
    @abc.abstractmethod
    def generate_scroll_coordinates(start_y: int, end_y: int):
        """
